...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.valueField.text = [NSString stringWithFormat:@"%d", item.valuePrice];
    ...
    UIImage *image = [[ImageStore sharedStore] imageForKey:key];
...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    item.valuePrice = [self.valueField.text intValue];
}
